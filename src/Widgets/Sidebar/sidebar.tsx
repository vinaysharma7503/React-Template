...
const sidebar = (props: Props) => {
    return (
        <div className="hidden lg:block shadow-lg relative w-80 overflow-auto">
            <div className="bg-white  rounded-2xl dark:bg-gray-700">
                ...
                <nav className="mt-6">
                    <div>
                        <Link className="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800 border-r-4 border-blue-500" to="/dashboard">
                        ...
                        <Link className="w-full font-thin uppercase text-blue-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" to="/dashboard/users">
                            <span className="text-left">
